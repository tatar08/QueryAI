...
- [x] [UI design system & visual identity: call for contributors](https://github.com/TabularisDB/tabularis/issues/195)
- [x] [SQL Server driver plugin, in development in its own repository](https://github.com/TabularisDB/tabularis-sqlserver-plugin)
...
- [x] [Data Transfer Wizard (Cross-database & table-to-table export)](https://github.com/TabularisDB/tabularis)
- [x] [Data Compare / Diff Tool](https://github.com/TabularisDB/tabularis/issues/21)
- [x] [MongoDB Driver & Query Support](https://github.com/TabularisDB/tabularis)
- [x] [Team Collaboration](https://github.com/TabularisDB/tabularis/issues/20)
...
- [x] [Web PIN (6–8 digits) & JWT Authentication](https://github.com/TabularisDB/tabularis)
